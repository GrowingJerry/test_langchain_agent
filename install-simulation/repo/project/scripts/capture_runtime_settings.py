...
TEXT_MODEL_FIELDS={
    "ollama_model","ollama_extraction_model","ollama_review_model","text_model",
    "requirement_atomizer_model","requirement_auditor_model","test_case_model",
    "test_case_review_model",
}
...
def main() -> int:
    ...
    if args.model:
        preserved.update({key:args.model for key in TEXT_MODEL_FIELDS})
