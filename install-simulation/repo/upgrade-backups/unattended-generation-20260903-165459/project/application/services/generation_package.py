...
def build_generation_package(
    ...
    *,
    ...
    return {
        ...
        # Output fit is reported by capacity_sufficient below. This flag is only
        # for an input package that cannot fit at all; using full num_predict or
        # requirement-wide output here falsely rejects otherwise splittable work.
        "may_exceed_context": input_tokens >= num_ctx,
        **capacity,
